...
/*   Updated: 2024/12/10 17:37:59 by akajjou          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    ClapTrap::set_hitpt(const int &hitpt)
{
    hit_points = hitpt;
}

void    ClapTrap::set_energypt(const int &energypt)
{
    energy_points = energypt;
}

void    ClapTrap::set_damage(const int &dammage)
{
    attack_damage = dammage;
}
